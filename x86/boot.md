...
| `023C` / `4` | 2.07+   | [hardware_subarch](hardware_subarch)            | Hardware subarchitecture                                    |
...
Please see the section on [SPECIAL COMMAND LINE OPTIONS](#special-command-line-options).
